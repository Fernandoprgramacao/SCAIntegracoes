object FrmIntegracao: TFrmIntegracao
  ...
  object pnFiltro: TPanel
    ...
    object lbEnviado: TLabel
      Left = 18
      Top = 68
      Width = 131
      Height = 16
      Caption = 'Enviado para a Vindi'
      Color = 15987694
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
    ...
    object cbEnviadoVindi: TComboBox
      Left = 18
      Top = 88
      Width = 165
      Height = 22
  ...
  object DBGrid1: TDBGrid
    ...
    Cursor = crHandPoint
    Color = 15986925
    DataSource = dsSolicitacoesVindi
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Segoe UI'
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'solicitacaoNomeFantasia'
      ...
      item
        Expanded = False
        FieldName = 'solicitacaoTipo'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'solicitacaoCPF'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'solicitacaoCNPJ'
        Visible = False
      end
      item
        Expanded = False
      ...
      item
        Expanded = False
        FieldName = 'solicitacaoExcluido'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'solicitacaoObs'
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'solicitacaoTarefa'
      ...
      item
        Expanded = False
        FieldName = 'solicitacaoDtCadastro'
  ...
  object ADOSolicitacoesVindi: TADOCommand
    Connection = BD.Conexao
    Parameters = <>
    Left = 432
    Top = 184
  end
  object dsSolicitacoesVindi: TDataSource
    DataSet = cdsSolicitacoes
    Left = 664
    Top = 184
  end
  object cdsSolicitacoes: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 560
    Top = 184
